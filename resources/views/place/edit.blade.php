...
{!! Form::open(array('url' => 'place/save','files'=>true)) !!}
		...
		<div class="form-group">
			...
			<div class="tab-content" style="padding: 0px;">
			  	<input class="form-control tab-pane fade in active" type="text" id="name_tha" placeholder="ชื่อสถานที่(ไทย)" name="name_tha" value="<?php echo $place[0]['name_tha'] ?>">
		...
		<div class="form-group">
			...
			<div class="tab-content" style="padding: 0px;">
			  	<input class="form-control tab-pane fade in active" type="text" placeholder="รายละเอียดโดยย่อ(ไทย)" id="shortdes_tha" name="shortdes_tha" value="<?php echo $place[0]['shortdes_tha'] ?>">
		...
		<div class="form-group">
			...
			<div class="tab-content" style="padding: 0px;">
			    <textarea class="form-control tab-pane fade in active" id="description_tha" name="description_tha" placeholder="รายละเอียด(ไทย)" rows="3"><?php echo $place[0]['description_tha'] ?></textarea>
		...
		<div class="form-group">
			<input type="checkbox" class="custom-control-input" name="recommend" <?php if($place[0]['recommend'] == 1) echo "checked" ?>>
		...
		<div class="form-group">
			...
			<div class="tab-content" style="padding: 0px;">
			    <textarea class="form-control tab-pane fade in active" id="recommendtxt_tha" name="recommendtxt_tha" placeholder="แนะนำ(ไทย)" rows="3"><?php echo $place[0]['recommendtxt_tha'] ?></textarea>
			    <textarea class="form-control tab-pane fade" id="recommendtxt_eng" name="recommendtxt_eng" placeholder="แนะนำ(อังกฤษ)" rows="3"><?php echo $place[0]['recommendtxt_eng'] ?></textarea>
			    <textarea class="form-control tab-pane fade" id="recommendtxt_cha" name="recommendtxt_cha" placeholder="แนะนำ(จีน)" rows="3"><?php echo $place[0]['recommendtxt_cha'] ?></textarea>
			</div>
		</div>
		...
		<div class="form-group dayrange">
		  	...
		  	<?php foreach($placeTime as $key2=>$value2){ ?>
		...
		<div class="form-group col-xs-10">
		  	<input class="form-control" type="text" placeholder="ข้อมูลเพิ่มเติม" name="timeps" value="<?php echo $place[0]['timeps'] ?>">
		</div>
		...
		<div class="form-group">
		  	...
		  	<input class="form-control" type="email" placeholder="Enter email" name="email" value="<?php echo $place[0]['email'] ?>">
		</div>

		<div style="clear:both"><br>
		<div class="form-group telrange">
		  	<label>เบอร์โทร</label> </br>
		  	<?php foreach($placetel as $key=>$value){ ?>
		  	<div class="telrange_part">
			  	...
			  	<div class="col-xs-4">
					<input class="form-control telephone" type="tel" placeholder="เบอร์โทร" name="tel[]" value="<?php echo $value['tel'] ?>" required>
				</div>
			</div><br><br>
			<?php } ?>
			</div>
		...
		<div class="form-group">
			...
			<div class="tab-content" style="padding: 0px;">
			    <textarea class="form-control tab-pane fade in active" id="address_tha" name="address_tha" placeholder="ที่อยู่(ไทย)" rows="3"><?php echo $place[0]['address_tha'] ?></textarea>
		...
		<div class="form-group">
		  	...
		  	<div class="col-xs-2">
		  		<input class="form-control" type="text" name="lat" value="<?php echo $place[0]['lat'] ?>">
		  	</div>
		  	<label class="col-xs-1 col-form-label">ลองติจูด</label>
		  	<div class="col-xs-2">
		  		<input class="form-control" type="text" name="lng" value="<?php echo $place[0]['lng'] ?>">
		  	</div>
		</div><div style="clear:both"><br>
		  ...
		  <div class="form-group">
		    ...
		    <?php foreach($category as $key=>$value){ ?>
			    <div class="form-group col-xs-4 col-form-label">
				  <input type="checkbox" class="custom-control-input" name="category[]" value="<?php echo $value['ID']  ?>" <?php if (in_array($value['ID'], $placeCategory)) echo 'checked'; ?>>
				  <span class="custom-control-indicator"></span>
		 ...
		 <div class="form-group">
			...
			<div class="tab-content" style="padding: 0px;">
			    <textarea class="form-control tab-pane fade in active" id="interview_tha" name="interview_tha" placeholder="บทสัมภาษณ์(ไทย)" rows="3"><?php echo $place[0]['interview_tha'] ?></textarea>
